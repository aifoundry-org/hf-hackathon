/*
 * Microbenchmark: scalar vs VPU 3x3 stride-2 conv comparison.
 *
 * Single-token kernel — measures cycles via the launcher's DBG emu_cycle line.
 * No dump region needed; the launcher reads total emulated cycles from sysemu.log.
 */
