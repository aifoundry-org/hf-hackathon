# Qwen3-1.7B Reproducibility Recipe

## Overview
This recipe documents the already-registered `qwen3_17b` model (`Qwen/Qwen3-1.7B`,
...
plus the benchmark config in `benchmarks/qwen3_17b.json`); this submission adds
...
- **GGUF source repo**: `ggml-org/Qwen3-1.7B-GGUF`
- **Revision (pinned)**: `daeb8e2d528a760970442092f6bf1e55c3b659eb`
- **Filename**: `Qwen3-1.7B-Q8_0.gguf`
- **Format**: Q8_0 GGUF
- **SHA256**: `9860780f3a1fab1f8f909a1b549ea3e62c22d19ab1a492b3a1026b38c5bd3ec3`
- **Size**: 2,165,039,200 bytes
- **License**: Apache-2.0

## Why this model
Qwen/Qwen3-1.7B is a strong open instruction model whose Q8_0 GGUF is supported
by the ET backend. The ET backend docs list non-MoE Qwen3 Q8_0 models as fully
supported, making it a useful edge-scale entry alongside the other `llama.cpp-et`
models.

## How the registered model is defined
1. **Provenance**: the `ggml-org` Q8_0 GGUF is pinned by commit revision,
   filename, SHA256, and byte size in `artifacts.json` (`qwen3_17b_q8_gguf`).
...
3. **Shared runner + scorer**: the registered benchmark config
   `ported_models/llama_cpp_et/benchmarks/qwen3_17b.json` uses the shared
...
`ported_models/llama_cpp_et/benchmarks/qwen3_17b.json` defines the ET-SoC1
