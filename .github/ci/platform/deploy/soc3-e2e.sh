...
SMOKE_ELF_SHA256=73756f7b4201f2becafdd561a0d3cfa15424799e63459038f13e439600e6c598
BOARD_LOCK=/var/lib/et-soc1-ci/board.lock
...
nohup env PYTHONPATH="\$PLATFORM" JOBS_API_URL="\$JOBS_API_URL" JOBS_DATA_DIR="\$JOBS_DATA_DIR" \
  ...
  SMOKE_ELF="\$SMOKE_ELF" SMOKE_ELF_SHA256="\$SMOKE_ELF_SHA256" \
  BOARD_LOCK="\$BOARD_LOCK" ET_BOARD_QUARANTINE_FILE="\$ET_BOARD_QUARANTINE_FILE" \
